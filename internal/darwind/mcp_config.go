...
// This mirrors internal/leashd/mcp_config.go so the macOS (Swift/ES + NE) path
// gets the same MCP observability posture as Linux instead of the previous
// hard-off proxy.MCPConfig{} (which left Mode == MCPModeOff). Default is Basic.
