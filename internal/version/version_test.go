...
// fails here.
var wantCapabilities = []string{"policy", "inject-service", "runtime", "user", "require-lsm", "machine-output", "version-json", "resolver-contract-json"}
...
func TestJSONWireShape(t *testing.T) {
	...
	want := map[string]any{
		...
		"capabilities":          []any{"policy", "inject-service", "runtime", "user", "require-lsm", "machine-output", "version-json", "resolver-contract-json"},
		"os":                    "linux",
		"arch":                  "amd64",
	}
